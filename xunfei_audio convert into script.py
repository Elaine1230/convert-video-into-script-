...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 10 21:26:19 2023
...
class RequestApi(object):
    ...
    def all_api_request(self):
        ...
        with open(self.to_file,'a', encoding='utf-8') as file_obj:
            file_obj.write(file)
            file_obj.write(";")
...
def convert(file):
    api = RequestApi(
        appid="aeccc264",
        secret_key="386d627cc40581fdddc7dcd67d646d8a",
        upload_file_path= path +"/"+ file,
        to_file=r"/Users/ytz/Desktop/mikebao_702.txt"
    )
    api.all_api_request() 
...
if __name__ == '__main__':
    #path_video_audio="/Users/ytz/Desktop/702-"#修改成现在存的文件的路径
    path = "/Users/ytz/Desktop/702" #文件夹目录
    ...
    for file in files:
        if not file=='.DS_Store':
            try:
                ...
                print("-----______________________重来———————____________________")
                print("_________________")
                restart_program()
...
#47f91b28    
#de7cd6113ba4399e21f48e5d222bb66e        
